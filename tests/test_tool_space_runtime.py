...
import my_conversation_app.tool_spaces as tool_spaces_mod
...
def _reload_core_tools() -> ModuleType:
    for module_name in list(sys.modules):
        if module_name.startswith("my_conversation_app.tools."):
            sys.modules.pop(module_name, None)

    sys.modules.pop("my_conversation_app.tools.core_tools", None)
    return importlib.import_module("my_conversation_app.tools.core_tools")

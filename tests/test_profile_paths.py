...
import my_conversation_app.prompts as prompts_mod
import my_conversation_app.personality as headless_mod
from my_conversation_app.config import DEFAULT_PROFILES_DIRECTORY, config
from my_conversation_app.personality import (
    DEFAULT_OPTION,
    read_tools_for,
    read_greeting_for,
    list_personalities,
...
#     \spaces--pollen-robotics--my_conversation_app
...
#   back to the budget: 101 + len("my_conversation_app\") (29) = 130.
#
...
def test_explicit_default_profile_does_not_fall_back_to_itself(
    ...
    with caplog.at_level(logging.WARNING, logger="my_conversation_app.prompts"):

...
import my_conversation_app.config as config_mod
from my_conversation_app.main import main
from my_conversation_app.mcp_client import RemoteToolSpec
from my_conversation_app.tool_spaces import (
...
def test_tool_spaces_add_list_remove_round_trip(
    ...
    monkeypatch.setattr(
        "my_conversation_app.tool_spaces.HfApi.space_info",
        lambda self, slug, **kwargs: _mock_public_space_info(slug),
    )
    monkeypatch.setattr(
        "my_conversation_app.tool_spaces.RemoteMcpToolClient.list_tool_specs",
...
def test_tool_spaces_add_installs_private_space_with_token(
    ...
    monkeypatch.setattr("my_conversation_app.tool_spaces.get_token", lambda: "hf_test_token")
    monkeypatch.setattr(
        "my_conversation_app.tool_spaces.RemoteMcpToolClient.list_tool_specs",
        _mock_list_tool_specs,
    )
...
def test_resolve_tool_space_prefers_app_config_hf_token(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("my_conversation_app.tool_spaces.get_token", lambda: None)
    monkeypatch.setattr(
        "my_conversation_app.tool_spaces.RemoteMcpToolClient.list_tool_specs",
        _mock_list_tool_specs,
    )
...
def test_tool_spaces_add_private_space_without_token_hints_at_auth(
    ...
    monkeypatch.setattr("my_conversation_app.tool_spaces.HfApi.space_info", _raise_not_found)
    monkeypatch.setattr(config_mod.config, "HF_TOKEN", None)
    monkeypatch.setattr("my_conversation_app.tool_spaces.get_token", lambda: None)

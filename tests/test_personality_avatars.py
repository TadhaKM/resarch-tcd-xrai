...
import my_conversation_app.personality as personality_mod
from my_conversation_app.config import config
from my_conversation_app.avatars import (
    DEFAULT_AVATAR_FILE,
    avatar_id_for,
    read_avatar_svg,
)
from my_conversation_app.personality import DEFAULT_OPTION
...
def test_avatar_unavailable_raises(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "my_conversation_app.personality_routes.read_avatar_svg",
        lambda name: None,
    )

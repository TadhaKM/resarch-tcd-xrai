...
from my_conversation_app.audio.startup_config import apply_audio_startup_config
...
class LocalStream:
    ...
    def _persist_personality(self, profile: Optional[str], voice_override: Optional[str] = None) -> None:
        ...
        try:
            from my_conversation_app.config import set_custom_profile
    ...
    def get_current_voice(self) -> str:
        ...
        try:
            from my_conversation_app.prompts import get_session_voice

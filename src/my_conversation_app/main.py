...
from my_conversation_app.utils import (
    parse_args,
    setup_logger,
...
def main() -> None:
    ...
    if args.command == "tool-spaces":
        from my_conversation_app.tool_spaces import handle_tool_spaces_command
...
def run(
    ...
    from my_conversation_app.console import LocalStream
    from my_conversation_app.tools.core_tools import ToolDependencies, initialize_tools
...
class MyConversationApp(ReachyMiniApp):  # type: ignore[misc]

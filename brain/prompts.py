...
_CAPABILITIES = (
    ...
    "antennas expressively; dance when asked; see through your camera and look "
    "at the person you are talking to; remember people you have met and what "
    "you discussed with them; and stop listening when asked to turn off. "
    "You cannot play music or sounds, move around the room (you have no wheels "
    "or legs), pick anything up (you have no arms), browse the internet, set "
    "reminders, control other devices, or see or read anything you are shown. "
